...
def get_llm() -> BaseChatModel:
    ...
    _cached_llm = ChatGoogleGenerativeAI(model=model_name, google_api_key=api_key).bind_tools(TOOL_DEFINITIONS)
    return _cached_llm
...
def build_graph(session: SessionState, llm: Optional[BaseChatModel] = None):
...
def run_agent_turn(
    ...
    compiled = build_graph(session, llm=llm)
